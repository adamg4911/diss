...
class PlaintextDataset(BaseDataset):
    ...
    def load_data(self) -> Any:
        ...
        with open('sign_data/'+self.split+"_text.txt", 'rb') as file:
            src_text_list=pickle.load(file)
        with open('sign_data/'+self.split+"_gloss.txt", 'rb') as file:
            trg_text_list=pickle.load(file)
        ...
        data = {self.src_lang: src_text_list}
        data[self.trg_lang] = trg_text_list
