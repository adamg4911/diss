...
class TrainManager:
    ...
    def __init__(self, model: Model, cfg: dict) -> None:
        ...
        elif self.early_stopping_metric in ["acc", "bleu", "chrf", "bleu2"]:  # higher is better
...
def train(cfg_file: str, skip_test: bool = False) -> None:
    ...
    dev_data = PlaintextDataset(path="dontmatter", src_lang="text", trg_lang="gloss", split="valid", sequence_encoder=sequence_encoder)
    test_data = PlaintextDataset(path="dontmatter", src_lang="text", trg_lang="gloss", split="test", sequence_encoder=sequence_encoder)
